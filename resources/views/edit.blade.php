...
<body>
    <div class="container">
        ...
        <form action="{{route('update', $note->id)}}" method="POST" class="d-flex flex-column align-items-center">
            @method('put')
            @csrf
            ...
            <button type="submit" value="Update" class="btn btn-primary mt-2">Actualizar</button>
        </form>
    </div>
</body>
</html>
